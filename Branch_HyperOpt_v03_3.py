# Finds the Best HyperParameters for the Branch Identification NN of Feeder C
...
def f_nn(params):
    dataset, output_class = V_feeder_noDC[2], Branch_Output_sorted[2]
    ...
    try:
        outfile = open(directory + r'\branch_id_v03_3.csv', 'wb')
        df.to_csv(outfile)
        outfile.close()
...
trainX, testX, trainY, testY = shuffle_dataset(V_feeder_noDC[2], Branch_Output_sorted[2])
